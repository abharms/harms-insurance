        ...
        <footer>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 bg-white py-24 bg-gray-50">
                ...
                <div className="md:col-start-8 md:col-span-2 text-center">
                    <a href="https://www.trustedchoice.com/agency-profile/140541/harms-insurance-agency/" rel="noreferrer" target="_blank"><img src={trustedChoiceLogo} alt="trusted choice logo" className="w-1/2 md:w-max m-auto" /></a>
                </div>
                <div className='md:col-start-10 md:col-span-2 text-center mt-8 md:mt-0'>
                    <a href="https://www.facebook.com/Harms-Insurance-Agency-Inc-102073558249643/reviews/?ref=page_internal" rel="noreferrer" target="_blank"><i className="fa-brands fa-facebook-f mr-5 text-3xl"></i></a>
                    <a href="https://www.linkedin.com/company/harmsinsuranceok/" rel="noreferrer" target="_blank"><i className="fa-brands fa-linkedin-in text-3xl"></i></a>
                </div>
